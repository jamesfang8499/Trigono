...
\begin{scope}[yshift=-7.5cm]
    ...
    \draw[->](0,-1.5)node[below]{(3)}--(0,1.5)node[left]{$y$};
\foreach \x in {-3,-2,...,3}
{
...
$\therefore\quad f_3(x)=\sin 2x$是周期 函数（周期 是$\pi$）.
\end{enumerate}
\end{solution}
...
\draw[very thick, domain=-2.5*pi:2.5*pi, samples=300]plot(\x, {sin(\x r)});
\foreach \x in {2,-2}
{
    \node at (\x*pi,0)[below]{$\x\pi$};
}
...
\draw[very thick, domain=-2*pi:2*pi, samples=300]plot(\x, {cos(\x r)});
\foreach \x in {2,-2}
{
    \draw(\x*pi,.2)--(\x*pi,0)node[below]{$\x\pi$};
}
...
\begin{scope}[yshift=-9cm]
    ...
    \draw[domain=-pi/2+.3:pi/2-.3, smooth, very thick, samples=100]plot(\x+pi, {tan(\x r)});
    \draw[domain=-pi/2+.3:pi/2-.3, smooth, very thick, samples=100]plot(\x-pi, {tan(\x r)});
    \draw[domain=-pi/2+.3:pi/2-.3, smooth, very thick, samples=100]plot(\x-2*pi, {tan(\x r)});
    \draw[domain=-pi/2+.3:pi/2-.3, smooth, very thick, samples=100]plot(\x+2*pi, {tan(\x r)});


\foreach \x in {-.5,-1.5,-2.5,.5, 1.5, 2.5}
{
    \draw[dashed](\x*pi,-3.5)--(\x*pi,3.5);
}
\node at (pi,0)[below]{$\pi$};
...
\end{scope}
\begin{scope}[yshift=-9cm, xshift=19cm]
    \draw[->](-8,0)--(9,0)node[below]{$x$};
    \draw[->](0,-4)node[below]{$y=\cot x$}--(0,4)node[left]{$y$};
    \node at (0,0)[below right]{$O$};    
    \draw[domain=0+.3:pi-.3, smooth, very thick, samples=100]plot(\x, {1/tan(\x r)});
    \draw[domain=0+.3:pi-.3, smooth, very thick, samples=100]plot(\x+pi, {1/tan(\x r)});
    \draw[domain=0+.3:pi-.3, smooth, very thick, samples=100]plot(\x-pi, {1/tan(\x r)});
    \draw[domain=0+.3:pi-.3, smooth, very thick, samples=100]plot(\x-2*pi, {1/tan(\x r)});
    \draw[domain=0+.3:pi/2+.5, smooth, very thick, samples=100]plot(\x+2*pi, {1/tan(\x r)});
...
\draw[domain=0:pi, smooth, very thick, samples=100]plot(\x-pi/6, {2*sin(2*\x r)})node[above]{$N$};
\foreach \x in {1,-1,-2}
{
    \draw(0,\x)--(.1,\x)node[right]{$\x$};
}
...
\node at (-pi/6,0)[below]{$-\frac{\pi}{6}$};
\node at (pi/3,0)[below left]{$\frac{\pi}{3}$};
\node at (pi/6*5,0)[below right]{$\frac{5\pi}{6}$};
\node at (-pi/6,0)[above left]{$M$};
\node at (pi/3,0)[above right]{$C$};
\node at (pi/12,2)[above]{$B$};
